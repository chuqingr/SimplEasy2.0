...
#warning 暂时侧拉框每个tabbar都可以，待改进
    RESideMenu *menu = [[RESideMenu alloc] initWithContentViewController:self.tabBarController leftMenuViewController:[JYCategoryController new] rightMenuViewController:nil];
